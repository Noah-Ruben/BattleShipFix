...
namespace Noah_Ruben
{
    public partial class Form1 : Form
    {
        ...
        {
            while (textBox12.Text != null)
            {
                changed++;
                this.textBox12.TextChanged -= textBox12_TextChanged;
                break;
            }
        }
        ...
        {
            while (textBox11.Text != null)
            {
                changed++;
                this.textBox11.TextChanged -= textBox11_TextChanged;
                break;
            }
        }
        ...
        {
            while (textBox10.Text != null)
            {
                changed++;
                this.textBox10.TextChanged -= textBox10_TextChanged;
                break;
            }
        }
